document.addEventListener('DOMContentLoaded', () => {
    ...
    const slideIntervals = new Map(); // Store intervals for each slideshow
    ...
    slideshows.forEach(slideshow => {
        ...
        function goToSlide(index) {
            currentSlide = index;
            updateSlides();
            resetAutoChange(); // Reset timer when manually changing slides
        }
        ...
        function startAutoChange() {
            autoChangeInterval = setInterval(nextSlide, 4000); // Changed to 4 seconds (4000ms)
        }
